...
1. Hardfork and Suspension Schedule
The migration will be synchronized based on Singapore Time (SGT), the central hub for our primary exchange partners.
...
2. Strategic Objectives of Migration
KINC Platform Integration: Polygon was selected to ensure the seamless deployment of 'KINC'. This transition optimizes debt securitization and ledger issuance, maximizing the utility of our RWA-based funding ecosystem.
...
3. Support for External Wallet Holders
We are committed to protecting the asset rights of all holders, including those using non-custodial wallets.
...
4. Important Investor Guidelines
Automatic Conversion: Assets held within collaborating exchanges (Gate.io, HTX, GOPAX) will be converted automatically. No manual action is required for exchange-based users.
